...
public class GameManager : NetworkBehaviour
{
    ...
    public override void OnNetworkSpawn()
    {
        ...
        playerCircleScore.OnValueChanged += (int prevScorer, int newScore) =>
        {
            OnScoreChanged?.Invoke(this, EventArgs.Empty);
        };
        playerCrossScore.OnValueChanged += (int prevScorer, int newScore) =>
        {
            OnScoreChanged?.Invoke(this, EventArgs.Empty);
        };
    }
    ...
    private bool TestWinnerType(PlayerType aPlayerType, PlayerType bPlayerType, PlayerType cPlayerType)
    {
